...
const navigation = [
  ...
  // { name: 'Chat Management', href: '/dashboard/chats', icon: MessageSquare, permission: 'chats' },
  {
    name: "Subscriptions",
  ...
  {
    name: "Reported Users",
    href: "/dashboard/reported",
    icon: UserX,
    permission: "reported",
  },
  {
    name: "Banned Users",
    href: "/dashboard/banned",
    icon: UserMinus,
    permission: "banned",
  },
  {
  ...
  // { name: 'Verifications', href: '/dashboard/verifications', icon: FileCheck, permission: 'verifications' },
  // { name: 'Activity Logs', href: '/dashboard/logs', icon: Activity, permission: 'logs' },
  // {

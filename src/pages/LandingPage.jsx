...
export const LandingPage = () => {
    ...
    const appScreenshots = [
        { id: 1, title: "Chat Interface", image: "/placeholder-01.jpg?height=480&width=240", theme: "dark", size: "tall" },
        { id: 2, title: "Profile Setup", image: "/placeholder-02.jpg?height=400&width=240", theme: "light", size: "medium" },
        { id: 3, title: "Video Call", image: "/placeholder-03.jpg?height=520&width=240", theme: "dark", size: "tall" },
        { id: 4, title: "Game Selection", image: "/placeholder-08.jpg?height=380&width=240", theme: "yellow", size: "medium" },
        { id: 5, title: "Match Dashboard", image: "/placeholder-05.jpg?height=500&width=240", theme: "dark", size: "tall" },
        { id: 6, title: "Settings", image: "/placeholder-06.jpg?height=420&width=240", theme: "light", size: "medium" },
        { id: 7, title: "Notifications", image: "/placeholder-07.jpg?height=360&width=240", theme: "gray", size: "short" },
        { id: 8, title: "Live Games", image: "/placeholder-08.jpg?height=480&width=240", theme: "purple", size: "tall" },
        { id: 9, title: "Messages", image: "/placeholder-09.jpg?height=440&width=240", theme: "light", size: "medium" },
        { id: 10, title: "Discover", image: "/placeholder-04.jpg?height=500&width=240", theme: "gradient", size: "tall" },
        { id: 11, title: "Payment", image: "/placeholder-06.jpg?height=380&width=240", theme: "yellow", size: "medium" },
        { id: 12, title: "Premium", image: "/placeholder-04.jpg?height=460&width=240", theme: "dark", size: "tall" },
    ]
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "All video calls are end-to-end encrypted and we never store or record your conversations.",
        },
        {
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 overflow-x-hidden">
                        ...
                        <div className="flex-1 text-center lg:text-left">
                            <div className="animate-fade-in-up">
                                ...
                                <p className="text-lg sm:text-xl md:text-2xl mb-6 md:mb-8 text-gray-300 animate-fade-in-up delay-300">
                                    Chat, video call, match & play live games with your perfect match.
                                </p>
                            </div>
            ...
            <section id="features" className="py-12 md:py-16 lg:py-24 relative">
                <div className="container mx-auto px-4">
                    <div
                        className={`text-center mb-12 md:mb-16 transition-all duration-1000 ${isVisible.features ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
                    >
                        ...
                        <p className="text-lg md:text-xl text-gray-300">Everything you need to find your perfect match</p>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        {/* Real-Time Chat Feature */}
                        <div
                            className={`group bg-gray-800/30 backdrop-blur-sm rounded-xl md:rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-2xl hover:shadow-cyan-500/20 transition-all duration-500 border border-gray-700/50 hover:border-cyan-500/50 transform hover:-translate-y-2 ${isVisible.features ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
                        ...
                        >
                            ...
                            <p className="text-gray-400 text-sm md:text-base">
                                Instantly message and connect with your matches in real-time conversations.
                            </p>
                        </div>

                        {/* Video Calling Feature */}
                        <div
                            className={`group bg-gray-800/30 backdrop-blur-sm rounded-xl md:rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-2xl hover:shadow-green-500/20 transition-all duration-500 border border-gray-700/50 hover:border-green-500/50 transform hover:-translate-y-2 ${isVisible.features ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
                        ...
                        >
                            ...
                            <p className="text-gray-400 text-sm md:text-base">
                                Make secure video calls with matches to get to know each other better.
                            </p>
                        </div>

                        {/* Live Games Feature */}
                        <div
                            className={`group bg-gray-800/30 backdrop-blur-sm rounded-xl md:rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-500 border border-gray-700/50 hover:border-purple-500/50 transform hover:-translate-y-2 ${isVisible.features ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
                        ...
                        >
                            ...
                            <p className="text-gray-400 text-sm md:text-base">
                                Play interactive games with other users to break the ice and have fun.
                            </p>
                        </div>

                        {/* Match Suggestions Feature */}
                        <div
                            className={`group bg-gray-800/30 backdrop-blur-sm rounded-xl md:rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-2xl hover:shadow-pink-500/20 transition-all duration-500 border border-gray-700/50 hover:border-pink-500/50 transform hover:-translate-y-2 ${isVisible.features ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
                        ...
                        <div
                            className={`group bg-gray-800/30 backdrop-blur-sm rounded-xl md:rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-2xl hover:shadow-cyan-500/20 transition-all duration-500 border border-gray-700/50 hover:border-cyan-500/50 transform hover:-translate-y-2 sm:col-span-2 lg:col-span-1 ${isVisible.features ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
            ...
            <section id="how-it-works" className="py-12 md:py-16 lg:py-24 relative overflow-hidden">
                <div className="container mx-auto px-4 relative z-10">
                    <div
                        className={`text-center mb-12 md:mb-16 transition-all duration-1000 ${isVisible["how-it-works"] ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
                    >
                        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-3 md:mb-4">
                            How It{" "}
                            <span className="bg-gradient-to-r from-green-400 to-cyan-400 bg-clip-text text-transparent">Works</span>
                        </h2>
                        <p className="text-lg md:text-xl text-gray-300">Get started in just a few simple steps</p>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {/* Step 1 - No Pulse Animation */}
                        <div
                            className={`text-center group transition-all duration-700 ${isVisible["how-it-works"] ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
                            style={{ transitionDelay: "100ms" }}
                        >
                            ...
                            <p className="text-gray-400 text-sm md:text-base">
                                Download the app and create your personalized profile to get started.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            <p className="text-gray-400 text-sm md:text-base">
                                Get matched with nearby users based on your preferences and interests.
                            </p>
                        </div>
            ...
            <section id="preview" className="py-12 md:py-16 lg:py-24 relative overflow-hidden">
                <div className="container mx-auto px-4">
                    <div
                        className={`text-center mb-12 md:mb-16 transition-all duration-1000 ${isVisible.preview ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
                    >
                        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-3 md:mb-4">
                            App{" "}
                        ...
                        <p className="text-lg md:text-xl text-gray-300">See what makes our app special</p>
                    </div>
                    ...
                    <div className="relative h-[600px] md:h-[800px] overflow-hidden">
                        ...
                        >
                            {[...appScreenshots, ...appScreenshots].map((screenshot, index) => (
                                <div key={`col1-${index}`} className="relative group">
                                    <div
                                        className={`w-full ${getPhoneHeight(screenshot.size)} bg-gradient-to-b from-gray-800 to-gray-900 rounded-2xl p-2 shadow-xl border border-gray-700/50 group-hover:border-cyan-500/50 transition-all duration-300 transform group-hover:scale-105`}
                                    >
                                        <div
                                            className={`w-full h-full ${getPhoneTheme(screenshot.theme)} rounded-xl overflow-hidden border border-gray-600/30`}
                                        >
                                            <img
                                    ...
                                    <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 bg-gray-800/90 backdrop-blur-sm border border-cyan-500/30 px-2 py-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                        <span className="text-xs font-semibold text-cyan-400">{screenshot.title}</span>
                                    </div>
                                </div>
                            ))}
                        </div>
                        ...
                        >
                            {[...appScreenshots.slice(3), ...appScreenshots.slice(3)].map((screenshot, index) => (
                                <div key={`col2-${index}`} className="relative group">
                                    <div
                                        className={`w-full ${getPhoneHeight(screenshot.size)} bg-gradient-to-b from-gray-800 to-gray-900 rounded-2xl p-2 shadow-xl border border-gray-700/50 group-hover:border-green-500/50 transition-all duration-300 transform group-hover:scale-105`}
                                    >
                                        <div
                                            className={`w-full h-full ${getPhoneTheme(screenshot.theme)} rounded-xl overflow-hidden border border-gray-600/30`}
                                        >
                                    ...
                                    <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 bg-gray-800/90 backdrop-blur-sm border border-green-500/30 px-2 py-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                        <span className="text-xs font-semibold text-green-400">{screenshot.title}</span>
                                    </div>
                                </div>
                            ))}
                        </div>
                        ...
                        >
                            {[...appScreenshots.slice(6), ...appScreenshots.slice(6)].map((screenshot, index) => (
                                <div key={`col3-${index}`} className="relative group">
                                    <div
                                        className={`w-full ${getPhoneHeight(screenshot.size)} bg-gradient-to-b from-gray-800 to-gray-900 rounded-2xl p-2 shadow-xl border border-gray-700/50 group-hover:border-purple-500/50 transition-all duration-300 transform group-hover:scale-105`}
                                    >
                                        <div
                                            className={`w-full h-full ${getPhoneTheme(screenshot.theme)} rounded-xl overflow-hidden border border-gray-600/30`}
                                        >
                                    ...
                                    <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 bg-gray-800/90 backdrop-blur-sm border border-purple-500/30 px-2 py-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                        <span className="text-xs font-semibold text-purple-400">{screenshot.title}</span>
                                    </div>
                                </div>
                            ))}
                        </div>
                        ...
                        >
                            {[...appScreenshots.slice(9), ...appScreenshots.slice(9)].map((screenshot, index) => (
                                <div key={`col4-${index}`} className="relative group">
                                    <div
                                        className={`w-full ${getPhoneHeight(screenshot.size)} bg-gradient-to-b from-gray-800 to-gray-900 rounded-2xl p-2 shadow-xl border border-gray-700/50 group-hover:border-pink-500/50 transition-all duration-300 transform group-hover:scale-105`}
                                    >
                                        <div
                                            className={`w-full h-full ${getPhoneTheme(screenshot.theme)} rounded-xl overflow-hidden border border-gray-600/30`}
                                        >
                                    ...
                                    <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 bg-gray-800/90 backdrop-blur-sm border border-pink-500/30 px-2 py-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                        <span className="text-xs font-semibold text-pink-400">{screenshot.title}</span>
                                    </div>
                                </div>
                            ))}
                        </div>
            ...
            <section id="testimonials" className="py-12 md:py-16 lg:py-24">
                <div className="container mx-auto px-4">
                    <div
                        className={`text-center mb-12 md:mb-16 transition-all duration-1000 ${isVisible.testimonials ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
                    >
                        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-3 md:mb-4">
                            Success{" "}
                        ...
                        <p className="text-lg md:text-xl text-gray-300">What our users are saying</p>
                    </div>
                            ...
                            <div className="text-center">
                                ...
                                <div className="flex items-center justify-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-400">Age {testimonials[currentTestimonial].age}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section id="faq" className="py-12 md:py-16 lg:py-24">
                <div className="container mx-auto px-4">
                    <div
                        className={`text-center mb-12 md:mb-16 transition-all duration-1000 ${isVisible.faq ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
                    >
                        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-3 md:mb-4">
                            Frequently Asked{" "}
                            <span className="bg-gradient-to-r from-cyan-400 to-green-400 bg-clip-text text-transparent">
                        ...
                        <p className="text-lg md:text-xl text-gray-300">Everything you need to know</p>
                    </div>

                    <div
                        className={`max-w-3xl mx-auto space-y-4 transition-all duration-1000 ${isVisible.faq ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
                    >
                        {faqs.map((faq, index) => (
                            <div
                                key={index}
            ...
            <section id="download" className="py-12 md:py-16 lg:py-24 text-white relative overflow-hidden">
                <div className="container mx-auto px-4 text-center relative z-10">
                    <div
                        className={`transition-all duration-1000 ${isVisible.download ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
                    >
                        ...
                        <div className="flex flex-col lg:flex-row items-center justify-center gap-6 md:gap-8">
                            ...
                            <div className="bg-gray-800/50 backdrop-blur-sm border border-cyan-500/30 p-3 md:p-4 rounded-xl md:rounded-2xl hover:border-cyan-500/60 transition-all duration-300 transform hover:scale-105">
                                <div className="w-24 h-24 md:w-32 md:h-32 bg-gray-700/50 rounded-lg flex items-center justify-center mb-2 border border-green-500/20">
                                    <span className="text-cyan-400 text-xs md:text-sm">QR Code</span>
                                </div>
                                <p className="text-cyan-400 text-xs md:text-sm">Scan to download</p>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                        ...
                        <div className="animate-fade-in-up">
                            ...
                            <p className="text-gray-400 text-sm md:text-base mb-4">
                                The ultimate dating app for finding love, fun, and real connections through chat, video calls, and
                                interactive games.
                            </p>
